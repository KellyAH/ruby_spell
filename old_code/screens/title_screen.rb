...
class TitleScreen
  ...
  def display_title
    ...
    title_banner = File.read('./old_code/fancy_text/title01.txt')
    ## ALTERNATE TITLE FONTS ##
    #title_banner = File.read('./old_code/fancy_text/title02.txt')
    #title_banner = File.read('./old_code/fancy_text/title03.txt')
